...
class login_window:
        ...
        #title-label 
            ...
            images = Image.open(r"images\ty.jpg")
            images = images.resize((500,130),Image.ANTIALIAS)
            self.photoimg_1 = ImageTk.PhotoImage(images)

            self.f_lbl = Button(self.root,image=self.photoimg_1)
            self.f_lbl.place(x=0,y=0,height=130,width=500)
            ...
            self.f_lbl1 = Button(self.root,image=self.photoimg4)
            self.f_lbl1.place(x=500,y=0,height=130,width=500)

            img3 = Image.open(r"images\smart-attendance.jpg")
            img3 = img3.resize((550,130),Image.ANTIALIAS)
            self.photoimg3 = ImageTk.PhotoImage(img3)

            self.f_lbl2 = Button(self.root,image=self.photoimg3)
            self.f_lbl2.place(x=1000,y=0,height=130,width=550) 
            ...
            self.lblimg=Button(image=self.photoimg,bg="black",borderwidth=0)
            self.lblimg.place(x=780,y=200,height=100,width=100)
            ...
            self.lblimg3=Button(image=self.photoimg1,bg="black",borderwidth=0)
            self.lblimg3.place(x=700,y=360,height=20,width=20)
            ...
            self.lblimg2=Button(image=self.photoimg2,bg="black",borderwidth=0)
            self.lblimg2.place(x=700,y=430,height=20,width=20)
            ...
            #forgot-password 
            forget_btn=Button(main_frame,command=self.forgot_pass,text="Forget Password",font=("time new roman",12,"bold"),borderwidth=0,relief=RIDGE,fg="white",bg="black",activeforeground="white",activebackground="black")
        ...
        def login(self):
            if self.txtuser.get()=="" or self.txtpwd.get()=="":
                ...
                if row==None:
                    messagebox.showerror("Error","Invalid Username and Passwoord !")
                else:
                    open_main=messagebox.askyesno("Success","you are logged in successfully")
                    if open_main>0:
                        self.new_window=Toplevel(self.root)
        ...
        def forgot_pass(self):
            if self.txtuser.get()=="":
                ...
                if row==None:
                    ...
                    l=Label(self.root2,text="Forget Password",font=("time new roman",20,"bold"),bd=3,fg="red")
